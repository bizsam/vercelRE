...
<form action="<?php osc_admin_base_url(true); ?>" method="get">
  ...
  <div>
    <h2><?php _e('Please enter your Yandex.Map ', 'yandex_maps'); ?></h2>
    <p>
      <label for="id" style="font-weight: bold;"><?php _e('API key', 'yandex_maps'); ?>:</label> <input type="text" name="webid" id="webid" value="<?php echo $webid; ?>" />
    </p>
    <p>
      <input type="submit" class="btn btn-submit" value="<?php _e('Save', 'yandex_maps'); ?>" />
    <p>
