<?php
/*
  Plugin Name: Yandex Maps Plugin
  Plugin URI: https://osclasspoint.com/
  Description: Plugin shows a Yandex Map on the location space of every item
  Version: 1.2.0
  Author: MB Themes
  Author URI: https://osclasspoint.com
  Author Email: info@osclasspoint.com
  Short Name: yandex_maps
  Plugin update URI: yandex_maps
  Support URI: https://forums.osclasspoint.com/free-plugins/
  Product Key: bct0VBUQPl1Po88uVapn
*/
...
function yandex_insert_geo_location($aItem) {
  ...
  $response = osc_file_get_contents(sprintf('https://maps.google.com/maps/geo?q=%s&output=json&sensor=false', urlencode($address)));
...
osc_add_hook('posted_item', 'yandex_insert_geo_location') ;
osc_add_hook('edited_item', 'yandex_insert_geo_location') ;
?>